...
import { getSources, addSource, removeSource, setDefaultSource, getConfigPath } from '../utils/configManager.js';
...
export function listSources() {
    ...
    for (const source of sources) {
        ...
        console.log(`    ${chalk.dim('→')} ${chalk.white(`${source.owner}/${source.repo}`)} ${chalk.dim(`[${source.branch}]`)}`);
    }
